...
const Home = () => (
    <main>
        ...
        <p className="mt-4 text-lg md:text-xl text-gray-600 font-light italic font-extrabold">
            We are delighted to invite you to celebrate our special day with us!
        </p>
        <h2 className="mt-8 text-2xl md:text-3xl custom-dancing-font tracking-wide">
            <span className="italic">Marina</span> <span className="">&amp;</span> <span className="italic">Orestis</span>
        </h2>
