...
const ThingsToDo = () => {
    ...
    const favouriteSpots = t('thingsToDo.thessaloniki.favourites', { returnObjects: true });
        ...
        <div className="section-padding">
            <div className="max-w-6xl mx-auto container-padding">
                ...
                <div className="space-y-8 mb-16">
                    {/* Thessaloniki */}
                    <div className="bg-white rounded-lg p-8 soft-shadow-lg border-2 border-amber-700">
                        ...
                        {Array.isArray(favouriteSpots) && favouriteSpots.length > 0 && (
                            <div className="mt-4 space-y-2">
                                {favouriteSpots.map((spot, idx) => (
                    ...
                    <div className="bg-white rounded-lg p-8 soft-shadow-lg border-2 border-amber-700">
                        ...
                        <div className="space-y-6">
                            {/* Kassandra */}
                            <div className="pl-4 border-l-4 border-amber-700">
                            ...
                            <div className="pl-4 border-l-4 border-amber-700">
                                ...
                                <ul className="list-none muted-text space-y-2">
                                    <li className="flex items-center gap-2">
                                        ...
                                        <a href="https://maps.app.goo.gl/bWKeCX1B6HYpSVww8" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                            </svg>
                                        </a>
                                    ...
                                    <li className="flex items-center gap-2">
                                        ...
                                        <a href="https://maps.app.goo.gl/cSdvqGWhCBJPu3AVA" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                            </svg>
                                        </a>
                                    ...
                                    <li className="flex items-center gap-2">
                                        ...
                                        <a href="https://maps.app.goo.gl/SheXsegJPrXG1rpN6" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                            </svg>
                                        </a>
                                    ...
                                    <li className="flex items-center gap-2">
                                        ...
                                        <a href="https://maps.app.goo.gl/AzuQXCqMFSys5Tkw6" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                            </svg>
                                        </a>
                                    ...
                                    <li className="flex items-center gap-2">
                                        ...
                                        <a href="https://maps.app.goo.gl/RQ7vN6xL6ZR9s5rv6" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                            </svg>
                                        </a>
