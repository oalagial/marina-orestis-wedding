    ...
    en: {
        translation: {
            ...
            schedule: {
                ...
                guestsArrive: "Guests Arrival",
                guestsArriveDesc: "Welcome drinks and mingling. Time to catch up with family and friends before the ceremony begins.",
                ceremony: "Wedding Ceremony", 
                ceremonyDesc: "The sacred moment where Marina and Orestis exchange vows and rings in front of their loved ones.",
                reception: "Reception & Lunch",
                receptionDesc: "Celebrate with a delicious meal, toasts, and wonderful conversations as we begin the festivities.",
    ...
    el: {
        translation: {
            ...
            schedule: {
                ...
                guestsArrive: "Άφιξη Καλεσμένων",
                guestsArriveDesc: "Ποτά καλωσορίσματος και κοινωνικοποίηση. Ώρα να συναντήσετε οικογένεια και φίλους πριν αρχίσει η τελετή.",
                ceremony: "Γαμήλια Τελετή",
                ceremonyDesc: "Η ιερή στιγμή όπου η Μαρίνα και ο Ορέστης ανταλλάσσουν όρκους και δαχτυλίδια μπροστά στους αγαπημένους τους.",
